package quocnguyen.demo.microservices.delivery.config;
...
import quocnguyen.demo.microservices.delivery.event_handler.OrderEventReceiver;

@Configuration
public class RabbitMQConfiguration {

	private static final String TOPIC_EXCHANGE_NAME = "order";
	private static final String LISTENING_QUEUE = "order-received";
	...
	@Bean
	MessageListenerAdapter listenerAdapter(OrderEventReceiver orderEventReceiver) {
